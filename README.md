...
The upload classes provide client-side compatibility with [Deepkit](https://deepkit.io/)'s `UploadedFile` type, in conjunction with OpenAPI specs generated by [deepkit-openapi](https://github.com/hanayashiki/deepkit-openapi). When a Deepkit backend exposes `UploadedFile` parameters, these classes satisfy the generated TypeScript types and automatically convert the request to multipart/form-data:
